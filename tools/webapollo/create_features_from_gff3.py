        ...
        for feature in rec.features:
            ...
            if "children" in featureData[0] and any(
                [
                    ...
                    for child in featureData[0]["children"]
                ]
            ):
                ...
                tRNA_sf = [
                    child for child in feature.sub_features if child.type == "tRNA"
                ][0]
                ...
                def func0():
                    wa.annotations.setName(
                        newfeature["features"][0]["uniquename"], tRNA_type
                    )
                ...
                sys.stdout.write(
                    "\t".join(
                        [feature.id, newfeature["features"][0]["uniquename"], "success"]
                    )
                )
                ...
                def func0():
                    wa.annotations.setName(
                        newfeature["features"][0]["uniquename"], "terminator"
                    )
                ...
                if args.source:
                    ...
                    gene_id = newfeature2.get(
                        "parent_id", newfeature2.get("uniquename", None)
                    )
                ...
                try:
                    ...
                    wa.annotations.setName(
                        ...
                        feature.qualifiers.get(
                            "product", feature.qualifiers.get("Name", ["Unknown"])
                        )[0],
                    )
                    time.sleep(0.5)
                    ...
                    sys.stdout.write("\t".join([feature.id, gene_id, "success"]))
                except Exception as e:
                    msg = str(e)
                    if "\n" in msg:
                        msg = msg[0 : msg.index("\n")]
                    sys.stdout.write("\t".join([feature.id, "", "ERROR", msg]))
            sys.stdout.write("\n")
