...
if __name__ == '__main__':
    ...
    load_result = wa.annotations.load_legacy_gff3(org_cn, args.gff3, args.source) # use_name=args.use_name, disable_cds_recalculation=args.disable_cds_recalculation)
