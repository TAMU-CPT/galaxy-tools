...
if __name__ == "__main__":
    ...
    cmd = "/galaxy/tools/cpt2/galaxy-tools/tools/external/Prophet/ProphET_standalone.pl --evalue_cutoff " + args.evalue_cutoff + " --window " + args.window + " --fasta " + args.fasIn + " --gff_in " + args.gffIn + " --outdir ./tempOut"
    try :
