...
with open('db.json', 'r') as handle:
    phage_names = json.load(handle)

phageNameLookup = {k['desc'].rstrip('.'): k['id'] for k in phage_names}
...
if __name__ == '__main__':
    ...
    data = important_only(data)
    data = deform_scores(data)
    data = filter_phage(data)
