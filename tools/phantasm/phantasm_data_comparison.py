...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate comparisons between two PHAnTASM datasets"
    )
    parser.add_argument(
        "file_a", type=argparse.FileType("r"), help="First Tabular Dataset"
    )
    parser.add_argument(
        "file_b", type=argparse.FileType("r"), help="Second Tabular Dataset"
    )
    choices = [
        "pdiff",
        "bit_diff",
    ...
    parser.add_argument(
        "comparison_method", choices=choices, help="Method for comparison"
    )
    parser.add_argument(
        "undef_value",
        nargs="?",
