                    ...
                    if featLvl2.type == "mRNA":
                        ...
                        for featLvl3 in featLvl2.sub_features:
                            ...
                            if featLvl3.type == "exon":
                                ...
                                if (
                                    featLvl3.location.start < featLvl2.location.start
                                    or featLvl3.location.start > featLvl2.location.end
                                ):
                                    errorMessage += (
                                    ...
                                    featLvl3.location.start != featLvl2.location.start
                                    and featLvl3.location.end != featLvl2.location.end
                                ):
                                    errorMessage += (
                        ...
                        if (
                            ...
                            if CDS == 1:
                                ...
                                if (
                                    cdsCheck.location.start != featLvl2.location.start
                                    and cdsCheck.location.end != featLvl2.location.end
                                ):
                                    errorMessage += (
