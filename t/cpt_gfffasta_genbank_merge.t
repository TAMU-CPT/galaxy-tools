...
@base = ('perl', 'bin/cpt_gfffasta_genbank_merge.pl');
my %result_files = (
  "Default" => {
    command_line => "--file_fasta test-data/inputs/inputfa_for_gff3.fa --file_gbk test-data/inputs/multi.gbk --file_gff test-data/inputs/example.gff3 --flatten_annotations  ",
    outputs => {
