...
@base = ('perl', 'bin/cpt_aa.pl');
my %result_files = (
  "Default" => {
    command_line => "--file test-data/inputs/single.gbk --results_format YAML ",
    outputs => {
      "results" => ["aa.yml", "test-data/outputs/aa.yml"],
    },
  },
  "normalized+individual" => {
    command_line => "--file test-data/inputs/single.gbk --normalize   --results_format YAML ",
    outputs => {
